...
@Component({
  selector: 'app-dasboard-venta-prepago-por-dia',
  templateUrl: './dasboard-venta-prepago-por-dia.component.html',
  styles: [`
...
export class DasboardVentaPrepagoPorDiaComponent implements OnInit {
  ...
  getData( ft = false) {
    ...
    this._api.restfulGet( '', 'Dashboard/ventaPrepagoMes' )
                .subscribe( res => {
                  ...
                  if( ft || !this.chart ){
                    this.chart = Highcharts.chart('containerPPdia', this.options);
                  }
